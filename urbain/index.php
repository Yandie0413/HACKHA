...
<div class="container">
    <div class="welcome-section">
        <h1>Bienvenue dans la Gestion energetique</h1>
        <p>Gérez votre conversion d'énérgie renouvelable</p>
        <a href="index.html" class="btn btn-custom">Accéder au Tableau de Bord</a>
    </div>
</div>
